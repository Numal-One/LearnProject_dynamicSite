        ...
        <div class="grid-container">
          ...
          <div class="header_logo"><a href="../index.php">
            ...
            <div class="header_menu">
              <ul class="menu">
                <li><a href="templatest/catalog.php">Аренда бытовок</a>
                  <ul class="submenu">
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Видном</a></li>
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Домодедово</a></li>
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Видном</a></li>
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Домодедово</a></li>
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Видном</a></li>
                    <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/catalog.php')?>">Аренда бытовок в Домодедово</a></li>
                ...
                <li><a href="W:/domains/learnKo3/ex4/4/templatest/price.php')">Цены</a></li>
                <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/delivery.php')?>">Доставка</a></li>
                <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/photogallery.php')?>">Фотогалерея</a></li>
                <li><a href="<?=($_SERVER['DOCUMENT_ROOT'] . '/ex4/4/templatest/contacts.php')?>">Контакты</a></li>
              </ul>
