<div class="grid-container">
        ...
        <div class="grid-container">
          <div class="seo_text"><img class="content-img" src="src/assets/img/rent1.png" alt="" title="">
            ...
            <p>внешняя и внутренняя отделка блок-контейнеров выполнена с применением современных качественных материалов, которые абсолютно безопасны для здоровья человека.</p><img src="src/assets/img/rent2.png">
          </div>
        </div>