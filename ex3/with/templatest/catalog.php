...
<?php include_once ("blocks/head.php");?>
  ...
  <body>
    ...
    <?php include_once ("blocks/mobile-menu.php");?>
            ...
            <div class="preview_bytovka-item">
              <div class="preview_bytovka-main">
                <div class="preview_bytovka-img">
                  <div class="preview_bytovka-slider"><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview1.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview1.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview2.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview2.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview3.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview3.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview4.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview4.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview5.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview5.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview6.png"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview6.png" alt="" title=""></a></div>
                </div>
              ...
              <div class="preview_bytovka-additional">
                ...
                <div class="preview_bytovka-icons"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/add-ic1.svg" alt="" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/add-ic2.svg" alt="" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/add-ic3.svg" alt="" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/add-ic4.png" alt="" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/add-ic5.svg" alt="" title=""></div>
              </div>
            </div>
            <div class="preview_bytovka-item">
              <div class="preview_bytovka-main">
