            ...
            <div class="card_bytovka-item">
              <div class="card_bytovka-main">
                <div class="card_bytovka-img">
                  ...
                  <div class="card_bytovka-for slider-dots"><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview1.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview1.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview2.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview2.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview3.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview3.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview4.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview4.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview5.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview5.png" alt="" title=""></a><a data-fancybox="sklad" href="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview6.png" title=""><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview6.png" alt="" title=""></a></div>
                  <div class="card_bytovka-nav">
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview1.png" alt="" title=""></div>
                    </div>
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview2.png" alt="" title=""></div>
                    </div>
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview3.png" alt="" title=""></div>
                    </div>
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview4.png" alt="" title=""></div>
                    </div>
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview5.png" alt="" title=""></div>
                    </div>
                    <div class="card_bytovka-nav-item">
                      <div class="card_bytovka-nav-wrap"><img src="http://<?=($_SERVER['SERVER_NAME'])?>/ex3/with/src/assets/img/preview6.png" alt="" title=""></div>
                    </div>
                  </div>
                </div>
