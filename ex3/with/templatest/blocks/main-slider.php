  ...
  <div class="grid-container">
    <div class="grid-x">
      <div class="main_slider">
        <div class="main_slider-item"><img src="./src/assets/img/bytovka1.png" alt="" title="">
        ...
        <div class="main_slider-item"><img src="./src/assets/img/bytovka2.png" alt="" title="">
        <div class="main_slider-substrate">
            <div class="main_substrate-heading">Строительные бытовки недорого!</div>
        ...
        <div class="main_slider-item"><img src="./src/assets/img/bytovka3.png" alt="" title="">
        <div class="main_slider-substrate">
            <div class="main_substrate-heading">Строительные бытовки недорого!</div>
        ...
        <div class="main_slider-item"><img src="./src/assets/img/bytovka4.png" alt="" title="">
        <div class="main_slider-substrate">
            <div class="main_substrate-heading">Строительные бытовки недорого!</div>
        ...
        <div class="main_slider-item"><img src="./src/assets/img/bytovka5.png" alt="" title="">
        <div class="main_slider-substrate">
            <div class="main_substrate-heading">Строительные бытовки недорого!</div>
        ...
        <div class="main_slider-item"><img src="./src/assets/img/bytovka6.png" alt="" title="">
        <div class="main_slider-substrate">
            <div class="main_substrate-heading">Строительные бытовки недорого!</div>
